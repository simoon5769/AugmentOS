        ...
        <View style={styles.appsContainer}>
            <View style={styles.titleContainer}>
                <Text style={[styles.sectionTitle, { color: textColor }]}>
                    {t('YourAppsList.Inactive Apps')} ({availableApps.length})
                </Text>
            </View>
            ...
            <MessageModal
                ...
                title={t('YourAppsList.Start Live Captions')}
                message={t('YourAppsList.start the Live Captions app')}
                buttons={[
                    { text: t("OK"), onPress: () => setOnboardingModalVisible(false) }
                ]}
                isDarkTheme={isDarkTheme}
